...
public class RespawnPointBlocker extends Module {
    ...
    public RespawnPointBlocker() {
        super(dev.indica.INDICA.INDICA.INDICA_CATEGORY, "respawn-point-blocker", "Prevents setting respawn points by blocking bed and respawn anchor interactions.");
    }
    ...
    private void onInteractBlock(InteractBlockEvent event) {
        ...
        // Check if this is a bed or respawn anchor interaction
